...
NOTE:
I've created this Project From Tutorials of love Babar . Initially I thought of building the same project then using it's resourses for E-commerce project but, this project itself was so large and comprehensive. It consumed a lot of time for debugging codebase and due to time constraint I Could not do things accourding to my plan
